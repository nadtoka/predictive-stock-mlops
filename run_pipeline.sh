...
STOCK_TICKER="NVDA,GOOG,AAPL,MSFT,AMZN,ASML,ADBE,TSM,V,META,BULL,AMD,NET,QBTS,RGTI,IONQ,IBM,FIG,BILL,NFLX,AVGO,UNH,FSLY,CAT,ETN,SNDK,SKHY,RKLB,INFQ,UBER,CHKP,MU,SNPS,CBRS"
